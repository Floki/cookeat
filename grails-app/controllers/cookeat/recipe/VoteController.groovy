...
class VoteController {
    ...
    def save(Vote voteInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'voteInstance.label', default: 'Vote'), voteInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'voteInstance.label', default: 'Vote'), params.id])
                redirect action: "index", method: "GET"
            }
