			...
			<ol class="property-list comment">
				...
				<li class="fieldcontain">
					<span id="owner-label" class="property-label"><g:message code="comment.owner.label" default="Owner" /></span>
						...
						<span class="property-value" aria-labelledby="owner-label"><g:link controller="user" action="show" id="${commentInstance?.owner?.id}">${commentInstance?.owner?.encodeAsHTML()}</g:link></span>
